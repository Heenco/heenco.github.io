...
.si-title-wrap { display: flex; flex-direction: column; gap: 0.1rem; margin-right: auto; }
.si-title { font-size: 0.9rem; font-weight: 600; color: hsl(var(--foreground)); line-height: 1.1; }
.si-subtitle { font-size: 0.72rem; color: hsl(var(--muted-foreground)); }
...
.si-close:hover { background: hsl(var(--accent)); color: hsl(var(--foreground)); }
